<?php  
	...
	if (isset($_SESSION['is_data_student_exist'])) {
		...
		$redirect = "<script> window.location='daftar_data_mahasiswa.php'; </script>";
	}
	        ...
	        <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
				...
				<div class="card" style="margin-top: 50px">
                    <div class="card-header" data-background-color="blue">
                        <h4 class="title">Data Mahasiswa Daftar TA</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="no_nim" required
                                        value="<?php isset($_SESSION['no_nim'])  ?  print($_SESSION['no_nim']) : ""; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="date" class="form-control" name="birth_date" value="<?php isset($_SESSION['birth_date'])  ?  print($_SESSION['birth_date']) : print("2002-01-01"); ?>" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                            	<div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="number" class="form-control" name="jmlh_sks" 
										value="<?php isset($_SESSION['jmlh_sks'])  ?  print($_SESSION['jmlh_sks']) : ""; ?>" 
                                        required>
                                    </div>
                              	...
                              	<div class="col-md-6">
                              		<div class="form-group label-floating">
                                        ...
                                        <input type="number" class="form-control" name="total_sks" 
										value="<?php isset($_SESSION['total_sks'])  ?  print($_SESSION['total_sks']) : ""; ?>"
                                        required>
                                    </div>
                              	</div>	
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" name="mhs_semester" 
										value="<?php isset($_SESSION['mhs_semester'])  ?  print($_SESSION['mhs_semester']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
