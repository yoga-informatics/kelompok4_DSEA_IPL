    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <div class="card-content">
                <?php  
                if ($upload_khs != "" && $upload_krs != "" && $foto_mahasiswa != "" && $bukti_pembayaran != "") {
                ...
                <ol>
                    ...
                    <li> 
                        <?php 
                            ...
                            if ($upload_khs != "" && $upload_krs != "") {

                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Fotocopy khs  dan kartu rencana studi<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Fotocopy khs  dan kartu rencana studi<i class="fa fa-check"></i></font>';
                                }else{
                                  echo '<font color="#2ecc71">Fotocopy khs  dan kartu rencana studi<i class="fa fa-check"></i></font> <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload khs dan Krs"><i class="fa fa-pencil"></i></a>';
                                }

                                
                            }else{
                                echo 'Fotocopy khs  dan kartu rencana studi <a href="index.php?page=5" class="btn btn-primary btn-sm" title="Upload khs dan Krs"><i class="fa fa-upload"></i></a>';
                            }
                    ...
                    <li>
                        <?php 
                            ...
                            if ($foto_mahasiswa != "" && $bukti_pembayaran != "") {

                                if ($daftar['status_pendaftaran'] == 1) {
                                    echo '<font color="#2ecc71">Foto mahasiswa dan bukti pembayaran<i class="fa fa-check"></i></font>';
                                }else if($daftar['status_pendaftaran'] >= 2){
                                    echo '<font color="#2ecc71">Foto mahasiswa dan bukti pembayaran<i class="fa fa-check"></i></font>';
                                }else{
                                    echo '<font color="#2ecc71">Foto mahasiswa dan bukti pembayaran<i class="fa fa-check"></i></font> <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload khs dan Krs"><i class="fa fa-pencil"></i></a>';
                                }
                                
                            }else{
                                echo 'Foto mahasiswa dan bukti pembayaran <a href="index.php?page=6" class="btn btn-primary btn-sm" title="Upload khs dan Krs"><i class="fa fa-upload"></i></a>';
                            }
